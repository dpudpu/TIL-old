...
public class Example10Bulk {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String _id = "7";
        IndexRequest one = new IndexRequest(INDEX_NAME)
                .id(_id)
                .source(XContentType.JSON, FIELD_NAME, "살아남은 아이");
        _id = "9";
        IndexRequest two = new IndexRequest(INDEX_NAME)
                .id(_id)
                .source(XContentType.JSON, FIELD_NAME, "프렌즈: 몬스터섬의비밀");
        _id = "8";
        IndexRequest three = new IndexRequest(INDEX_NAME)
                .id(_id)
